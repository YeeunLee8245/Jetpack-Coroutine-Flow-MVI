...
inline val PDsS.kotlinKapt: PDS get() = kotlin("kapt")  // = id "kotlin-kapt
inline val PDsS.daggerHiltAndroid: PDS get() = id("dagger.hilt.android.plugin") // = id "dagger.hilt.android.plugin"
